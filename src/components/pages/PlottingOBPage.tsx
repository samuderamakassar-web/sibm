...
// Fix bug timezone: sebelumnya pakai d.toISOString().split("T")[0] (basis UTC),
// jadi salah 1 hari kalau device jalan di WITA (UTC+8) pas dini hari — sama kelas
// bug dengan yang sudah difix di ChecklistOBPage & DeepCleaningPage (todayISO).
// Sekarang pakai komponen tanggal lokal, dipakai juga di generateSebulan biar
// tanggal yang di-generate konsisten dengan kalender lokal, bukan UTC.
